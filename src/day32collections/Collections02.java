...
public class Collections02 {
	/*
	  Hashing Technique : It is a technique to create unique codes for every elements in a Collection
	  ["A","B","A","C"]
	 */
	
	/*
	    1) Set Interface has three implementations : a) HashSet b)LinkedHashSet  c) TreeSet
	...
	/*
	 Hashet :
	 1) HashSet does not put the elements in any order.It puts the elements in random order.
	...
	/*
	 ...
	 4) TreeSet is very slow because of that we do not prefer to use TreeSet even we need sorted Collections
	 */

	public static void main(String[] args) {
		
		//By selecting data type as "Object" or by not declaring data type,
		  //you can store multiple data types in a Collection
