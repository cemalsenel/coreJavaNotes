...
//		System.out.println(list1.get(2));//There is no index 4, because of that you will get run time error
...
//		System.out.println(list2.remove(6));//IndexOutOfBoundsException
		
		//How to remove an element from a list by using the element value
		//For integer lists, you cannot remove an element by using element value,
...
//		System.out.println(list2.remove(19));
		...
		list3.remove("Mary");
		System.out.println(list3.remove("Mary"));//true (remove("MaryX") returns false)
		...
		list3.set(list3.indexOf("Sunny"),"Johnny");
		System.out.println(list3);
