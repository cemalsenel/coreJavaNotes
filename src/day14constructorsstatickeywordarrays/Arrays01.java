...
public class Arrays01 {
	 ...
	 * 2) An Array can have just a
	 *    single data type If you decide to store integers into an array, you can store
	 *    just integers not the others 
	 * 3)  Arrays accept just "primitive data types" as
	 *     elements, when you put "String" in an array, Java stores their "references"
	 *     inside the array, not the String itself.
	 */
	...
	public static void main(String[] args) {
		 ...
		 * 4) Use "new" keyword 
         * 5) Put the data type again with brackets "[]" 6) And put how
		 *    many variables will array include
		 */
		...
		//If you try to add elements more than the size of array,you will get run time error
//		array2[4] = "Angie";
//		System.out.println(Arrays.toString(array2));
		...
		do {
            ...
            for (int i = 0 ; i<array2.length;i++) {
            	array2[i] = array2[i].replace("J", "*");//without assignment, we cannot see permanent assignment on console.
            }
            System.out.println(Arrays.toString(array2));
	}
