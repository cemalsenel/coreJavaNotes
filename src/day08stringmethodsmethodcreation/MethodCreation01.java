...
public class MethodCreation01 {
	...
	/*
	 ...
	 4) "static" methods can use just static class members, because of that if you will call a method from inside the main
	    method you have to make it "static".
	...
	/*
	 ...
	 To make parameters different we have 3 ways:
	     1)Change data type of parameter or parameters.
	     2)Change the number of parameters.
	     3)If the data types are different , you may change their order.
