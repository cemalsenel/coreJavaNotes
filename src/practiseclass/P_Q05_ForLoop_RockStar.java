...
public class P_Q05_ForLoop_RockStar {
	...
	public static void main(String[] args) {
		/*
		 * Ask user to enter an integer and type a program: For numbers which are a
		 * multiple of 3, print Rock instead of number, and for numbers which are a
		 * multiple of 5, print Star instead of the number. For numbers which are a
