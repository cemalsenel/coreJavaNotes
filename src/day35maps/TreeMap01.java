...
public class TreeMap01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(tm.firstEntry());//4=Angie Moon (must be sorted first)
		
		System.out.println(tm.floorEntry(15));//13=Veli Han
		
		System.out.println(tm.floorKey(9));//4
		
		System.out.println(tm.headMap(13));//{4=Angie Moon, 12=Ali Can} => 13 is exclusive  =>from head to 13
		System.out.println(tm.headMap(13, true));//{4=Angie Moon, 12=Ali Can, 13=Veli Han} => to make 13 inclusive, use "true"
		
		System.out.println(tm.tailMap(13));//{13=Veli Han, 21=Mary Star, 123=Tom Hanks} => 13 is inclusive => from 13  to tail
		System.out.println(tm.tailMap(13, false));//{21=Mary Star, 123=Tom Hanks} => to make 13 exclusive, use "false"
