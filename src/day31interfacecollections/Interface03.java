...
1) If you want to create "methods with body" in interfaces you have two options;
      a) Use "default" keyword before return type.Over here "default" keyword is not access modifier.
      If you create a method in an interface by using "default" keyword, those methods are called "default methods"
      
      b) Use "static" keyword before return type. "static" keyword is "static keyword"
      (public is ok for both writing or without writing)
      
      Note : Difference between "default methods" and "static methods" in an interface : 
             a) "default methods" can be called just by "objects"
