...
public class javaAdvance_01_FibonacciSeriesForAnyNumber {
	/*
	 * Write a method which accepts an integer as parameter
         ...
         * “Fibonacci series contains your number” or
	...
	public static void main(String[] args) {
		...
		if(fibo) {
			System.out.println("Fibonacci series contains your number");
		}else {
			System.out.println("Fibonacci series contains that numbers : " + num2 +" and "+num1);
		}
