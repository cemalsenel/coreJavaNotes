...
//		try {
//			Files
//			.lines(Paths.get("C:/Users/Sersefil/eclipse-workspace/winterjava01/src/lambda/lamdaFile.txt"))
...
//		try {
//			Files
//			.lines(Paths.get("C:/Users/Sersefil/eclipse-workspace/winterjava01/src/lambda/lamdaFile.txt")).map(String::toUpperCase)
//			.forEach(t->System.out.println(t));
//		} catch (IOException e) {
//			System.out.println("I could not read the file" +e.getMessage());
//		}
...
//		try {
//			boolean result = Files.lines(Paths.get("C:/Users/Sersefil/eclipse-workspace/winterjava01/src/lambda/lamdaFile.txt"))
...
//		try {
//			Files.lines(Paths.get("C:/Users/Sersefil/eclipse-workspace/winterjava01/src/lambda/lamdaFile.txt"))
//					.map(t-> t.split(" "))
